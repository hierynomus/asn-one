...
class ASN1InputStreamSpec extends Specification {
  ...
  def "supports largest value in short length form"() {
    given:
    def is = new ASN1InputStream(new BERDecoder(), [
      0x02, 0x7f, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
      ...
      0x77, 0x78, 0x79, 0x7a, 0x7b, 0x7c, 0x7d, 0x7e, 0x7f] as byte[])

    when:
    def tag = is.readTag()
    def length = is.readLength()
